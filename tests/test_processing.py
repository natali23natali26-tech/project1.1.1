...
@pytest.mark.parametrize(
    ...
    [
        ([{'id': 1, 'state': 'EXECUTED'}, {'id': 2, 'state': 'CANCELED'}, {'id': 3, 'state': 'EXECUTED'}], 'EXECUTED', [{'id': 1, 'state': 'EXECUTED'}, {'id': 3, 'state': 'EXECUTED'}]),
        ([{'id': 1, 'state': 'CANCELED'}, {'id': 2, 'state': 'CANCELED'}], 'EXECUTED', []),
        ([{'id': 1, 'state': 'EXECUTED'}, {'id': 2, 'state': 'PENDING'}, {'id': 3, 'state': 'EXECUTED'}], 'CANCELED', []),
    ]
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            [{'id': 1, 'date': '2022-04-01T15:00:00'}, {'id': 2, 'date': '2022-01-01T15:00:00'}, {'id': 3, 'date': '2022-03-01T15:00:00'}],
            True,
            [{'id': 1, 'date': '2022-04-01T15:00:00'}, {'id': 3, 'date': '2022-03-01T15:00:00'}, {'id': 2, 'date': '2022-01-01T15:00:00'}]
        ),
        (
            [{'id': 1, 'date': '2022-01-01T15:00:00'}, {'id': 2, 'date': '2022-01-01T15:00:00'}, {'id': 3, 'date': '2022-02-01T15:00:00'}],
            False,
            [{'id': 1, 'date': '2022-01-01T15:00:00'}, {'id': 2, 'date': '2022-01-01T15:00:00'}, {'id': 3, 'date': '2022-02-01T15:00:00'}]
        ),
    ]
...
@pytest.mark.parametrize(
    "input_data, reverse",
    [
        ([{'id': 1, 'date': '2022-01-01T15:00:00'}, {'id': 2, 'date': 'not_a_date'}], True),
        ([{'id': 1, 'date': 'invalid_date'}, {'id': 2, 'date': None}], False)
    ]
)
